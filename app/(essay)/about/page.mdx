...
- **Floor** – the amount excluded from the scope of my token. I'm planning to set this to $20M, in a way that accounts for inflation. If you don't think I can create a lot more than $20M of value over my life, participating doesn't make sense.
...
2. Ship my token's mechanics onchain to enable trading within my village. This will start with a seed round (priced).
3. Find others who wish to launch their personal tokens and help out however I can (and hopefully have the chance to invest in their tokens).

And we go from there...

## Source

[Source repo](https://github.com/homan9/personal-token) that contains the whitepaper, the agreement, the code, and implementation notes.
